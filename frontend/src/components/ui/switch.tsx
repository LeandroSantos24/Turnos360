  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block size-5 rounded-full bg-white shadow-md ring-0 transition-transform group-data-[checked]/switch:translate-x-5 group-data-[unchecked]/switch:translate-x-0"
      />
    </SwitchPrimitive.Root>
  )
}
